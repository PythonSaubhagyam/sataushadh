          ...
          <Drawer isOpen={isOpen} onClose={onClose} placement="left" finalFocusRef={menuButtonRef}>
            ...
            <DrawerContent>
              ...
              <DrawerHeader as={Flex} justify="center">
                <Link as={ReactRouterLink} to="/">
                  <Image loading="lazy" boxSize="120px" objectFit="contain" src="/satveda_logo.png" alt="SOSE Logo" />
                </Link>
              </DrawerHeader>
          ...
          >
            ...
            >
              <Link
                ...
                as={ReactRouterLink}
                to={"https://www.facebook.com/sataushadh.in"}
              >
              ...
              isExternal={true}
              as={ReactRouterLink}
              to={"https://www.instagram.com/cofeeco.in/"}
            >
              ...
              <Link
                ...
                isExternal={true}
                as={ReactRouterLink}
                to={"https://www.youtube.com/channel/UCsXN1sas9OAskvUWiX9eJyw"}
              >
            ...
            >
              ...
              <Link
                ...
                as={ReactRouterLink}
                to={
                  "https://play.google.com/store/apps/details?id=com.sose.satveda"
                }
              >
